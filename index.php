  ...
  <section class="section-lg bg-slate-50">
    <div class="max-w-7xl mx-auto px-6 lg:px-12">
      <div class="mb-16 text-center">
        <h2 class="text-4xl font-bold mb-4">글로벌 파트너</h2>
        <p class="text-gray-500 text-lg">세계 최고 기업들의 신뢰를 받고 있습니다</p>
      </div>

      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <!-- 배터리 · 모빌리티 -->
        <div class="bg-white p-8 rounded-lg border border-slate-200 hover:shadow-lg transition">
          <p class="text-sm font-semibold text-emerald-600 uppercase tracking-wider mb-3">배터리 · 모빌리티</p>
          <ul class="space-y-4 text-slate-700">
            <li class="flex gap-3">
              <span class="text-emerald-500 font-bold">→</span>
              <span><strong>삼성SDI</strong> — 2차전지 배터리 가스켓 (70% 공급점유율)</span>
            </li>
            <li class="flex gap-3">
              <span class="text-emerald-500 font-bold">→</span>
              <span><strong>현대·기아차</strong> — VCM 전원공급장치, EV 배터리 부품</span>
            </li>
            <li class="flex gap-3">
              <span class="text-emerald-500 font-bold">→</span>
              <span><strong>GM</strong> — EV 플랫폼 Busbar Cover 양산</span>
            </li>
            <li class="flex gap-3">
              <span class="text-emerald-500 font-bold">→</span>
              <span><strong>유라코퍼레이션</strong> — 자동차 부품</span>
            </li>
          </ul>
        </div>
        ...
        <!-- 디스플레이 · 전자 -->
        <div class="bg-white p-8 rounded-lg border border-slate-200 hover:shadow-lg transition">
          <p class="text-sm font-semibold text-blue-600 uppercase tracking-wider mb-3">디스플레이 · 전자</p>
          <ul class="space-y-4 text-slate-700">
            <li class="flex gap-3">
              <span class="text-blue-500 font-bold">→</span>
              <span><strong>삼성전자</strong> — TV Front Cover, 도광판, CamDeco</span>
            </li>
            <li class="flex gap-3">
              <span class="text-blue-500 font-bold">→</span>
              <span><strong>코니카미놀타</strong> — OA Finisher, 복합기 본체</span>
            </li>
            <li class="flex gap-3">
              <span class="text-blue-500 font-bold">→</span>
              <span><strong>솔루엠</strong> — ESL (전자선반가격표) 부품</span>
            </li>
          </ul>
        </div>
        ...
        <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 p-8 rounded-lg border border-emerald-200">
          <p class="text-sm font-semibold text-emerald-700 uppercase tracking-wider mb-3">글로벌 신뢰</p>
          <div class="space-y-4">
            <p class="text-slate-700 leading-relaxed">
              <strong>배터리, 자동차, 디스플레이, 전자 산업</strong>의 선두 기업들이 우리를 파트너로 선택합니다.
            </p>
            <p class="text-slate-700 leading-relaxed">
              까다로운 품질 기준을 충족하는 우리의 기술과 신뢰성이 글로벌 시장에서 검증되었습니다.
            </p>
            <ul class="space-y-2 text-sm text-slate-700 mt-4">
              <li>✓ IATF16949 인증</li>
              <li>✓ 현대차 SQ 인증</li>
              <li>✓ 44건 특허 보유</li>
            </ul>
