    ...
    <div class="relative max-w-7xl mx-auto px-6 lg:px-12">
      <div class="mb-6">
        <nav class="text-sm text-gray-300">
          ...
          <span class="mx-2">/</span>
          <span class="text-emerald-400 font-semibold">경영이념 및 비전</span>
        </nav>
      </div>
      ...
      <p class="text-lg lg:text-xl text-gray-300 font-light">
        설립이념과 핵심가치를 바탕으로 지속적인 성장과 혁신을 추구합니다
      </p>
    </div>
  </section>
  ...
  <section class="section-lg bg-white">
    <div class="max-w-7xl mx-auto px-6 lg:px-12">
      <div class="mb-16 text-center">
        <h2 class="text-4xl font-bold mb-4">설립이념</h2>
        <p class="text-gray-500 text-lg">삼진엘앤디의 경영 철학</p>
      </div>
  ...
  <section class="section-lg bg-slate-50">
    <div class="max-w-7xl mx-auto px-6 lg:px-12">
      <div class="text-center">
        <h2 class="text-5xl lg:text-6xl font-black mb-6 bg-gradient-to-r from-emerald-600 to-slate-900 bg-clip-text text-transparent">
