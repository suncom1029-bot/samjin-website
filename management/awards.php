    ...
    <div class="relative max-w-7xl mx-auto px-6 lg:px-12">
      <div class="mb-6">
        <nav class="text-sm text-gray-300">
          ...
          <span class="mx-2">/</span>
          <span class="text-emerald-400 font-semibold">수상 및 인증</span>
        </nav>
      </div>
  ...
  <section class="section-lg bg-slate-50">
    <div class="max-w-7xl mx-auto px-6 lg:px-12">
      <div class="mb-16 text-center">
        ...
        <p class="text-gray-500 text-lg">국제 표준 및 산업별 인증</p>
      </div>
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-12">
      <div class="bg-gradient-to-r from-emerald-600 to-slate-900 text-white p-12 lg:p-16 rounded-lg">
        <div class="text-center">
          <h2 class="text-3xl lg:text-4xl font-bold mb-4">신뢰의 증명</h2>
          <p class="text-lg text-emerald-100 mb-8">
            35년간의 기술 혁신과 품질 우수성을 인정받은<br>
            국내외 주요 인증과 수상으로 입증된 삼진엘앤디의 경쟁력
          </p>
          <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div class="text-center">
              <p class="text-3xl font-bold mb-2">8+</p>
              <p class="text-sm text-emerald-100">주요 수상</p>
            </div>
            <div class="text-center">
              <p class="text-3xl font-bold mb-2">5+</p>
              <p class="text-sm text-emerald-100">기술 특허</p>
            </div>
            <div class="text-center">
              <p class="text-3xl font-bold mb-2">4+</p>
              <p class="text-sm text-emerald-100">국제 인증</p>
            </div>
            <div class="text-center">
              <p class="text-3xl font-bold mb-2">35년</p>
              <p class="text-sm text-emerald-100">신뢰의 역사</p>
            </div>
          </div>
        </div>
      </div>
